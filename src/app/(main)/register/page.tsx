    ...
    <main className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            <label className={labelCls}>이메일 <span className="text-slate-400 font-normal">(PIN 찾기용)</span></label>
            <input value={form.email} onChange={set("email")} type="email" className={inputCls} placeholder="example@email.com" autoComplete="email" required />
          </div>
